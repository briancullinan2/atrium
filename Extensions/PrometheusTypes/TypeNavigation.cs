...
public static partial class TypeExtensions
{
    ...
    */
    ...
    private static IEnumerable<ParsedRoute> GetRoutes(Type componentType)
    {
        ...
        // used for finding login component with ILogin interface that has ReturnUrl
    ...
    public static string GetUri(Type componentType, Dictionary<string, string?>? initializer = null)
    {
        ...
        var bestRoute = matchedRoutes.FirstOrDefault() ?? throw new InvalidOperationException("Component " + componentType + " is unlinkable.");
