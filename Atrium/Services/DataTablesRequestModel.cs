...
namespace Atrium.Services
{
    internal class DataTablesRequestModel
    {
        ...
        public List<DataLayer.Utilities.DataTablesRequestModel.ColumnFilter> ColumnFilters { get; set; } = [];
        public List<DataLayer.Utilities.DataTablesRequestModel.Sort> Sorts { get; set; } = [];

        public static async ValueTask<DataLayer.Utilities.DataTablesRequestModel?> BindAsync(HttpContext context)
        {
            ...
            for (int i = 0; i < model.Columns; i++)
            {
                ...
                model.ColumnFilters.Add(new DataLayer.Utilities.DataTablesRequestModel.ColumnFilter
                {
            ...
            for (int i = 0; i < model.SortingCols; i++)
            {
                ...
                model.Sorts.Add(new DataLayer.Utilities.DataTablesRequestModel.Sort
                {
